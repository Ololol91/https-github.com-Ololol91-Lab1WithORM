        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_Clients_IdClient",
                        column: x => x.IdClient,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Creators_Countries_IdCountry",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Creators_IdCreator",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateDelivery = table.Column<string>(nullable: true),
                    DateDeparture = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sendings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sendings_Employees_IdEmployee",
                        column: x => x.IdEmployee,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sendings_Order_IdOrder",
                        column: x => x.IdOrder,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sendings_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sendings_Providers_IdProvider",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sendings_IdEmployee",
                table: "Sendings",
                column: "IdEmployee");

            migrationBuilder.CreateIndex(
                name: "IX_Sendings_IdOrder",
                table: "Sendings",
                column: "IdOrder");

            migrationBuilder.CreateIndex(
                name: "IX_Sendings_IdProduct",
                table: "Sendings",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_Sendings_IdProvider",
                table: "Sendings",
                column: "IdProvider");
        }
