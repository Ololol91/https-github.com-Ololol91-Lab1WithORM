...
namespace WebApplication1.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(ScladContext context)
        {
            _context = context;
        }
        ...
        {
            var scladContext = _context.Employees.Include(e => e.Post);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Surname,Name,Patronymic,Mobile_Number,IdPost")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
