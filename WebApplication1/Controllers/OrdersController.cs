...
namespace WebApplication1.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(ScladContext context)
        {
            _context = context;
        }
        ...
        {
            var scladContext = _context.Order.Include(o => o.Client);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdClient,Data")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
